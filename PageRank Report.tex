...
\begin{itemize}
	...
	\[
		(alpha*P)+((1-alpha)/n)*et
	\]
	Où alpha est un paramètre compris entre 0 et 1, P la matrice de probabilité , n étant le nombre de noeuds , et un vecteur colonne composé uniquement de 1.
\end{itemize}

% TODO power method : à faire
\subsection{Power method}

% TODO de quoi t'aider

% partie complete normalement
...
% hack for page skip https://tex.stackexchange.com/a/24068/129702
{\let\clearpage\relax \chapter{Implémentation}}
...
\section{Matrice de probabilité de transition : $P^{t}$ }
\[
\begin{pmatrix} 
